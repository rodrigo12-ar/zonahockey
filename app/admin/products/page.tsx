          ...
          <div className="flex flex-col gap-4 rounded-[2rem] border border-white/10 bg-slate-950/80 p-8">
            <div className="flex flex-wrap items-center justify-between gap-4">
              <div>
                ...
                <h1 className="mt-3 text-3xl font-semibold text-white">Gestión de productos</h1>
              </div>
              <Link href="/admin/products/new" className="rounded-full bg-accent px-5 py-3 text-sm font-semibold text-slate-950 transition hover:bg-accentDark">
                  ...
                  {products.map((product) => (
                    <tr key={product.slug} className="hover:bg-white/5">
                      ...
                      <td className="px-6 py-4">
                        <Link href={`/admin/products/${product.slug}`} className="rounded-full border border-white/10 px-4 py-2 text-sm text-slate-200 transition hover:border-accent hover:text-white">
                          Editar
                        </Link>
                      </td>
                    </tr>
