        ...
        <section className="w-full">
          <div className="rounded-[2rem] border border-white/10 bg-slate-950/80 p-8 shadow-soft">
            <div className="mb-8">
              ...
              <h1 className="mt-3 text-3xl font-semibold text-white">Editar fotografía</h1>
            </div>
            <PhotoForm action="edit" endpoint={`/api/admin/photos/${product.slug}`} initialData={product} />
          </div>
        </section>
      </main>
    </div>
